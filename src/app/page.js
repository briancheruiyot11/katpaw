  ...
  return (
    <main className=" max-w-5xl mx-auto px-6 py-12">
      ...
      <section className="text-center mb-12">
        ...
        <p className="text-neutralgray-600 text-lg">
      ...
      <section className="flex flex-col md:flex-row items-center md:items-start gap-8 mb-16">
        ...
        <div className="w-full md:w-1/2">
          ...
          <p className="text-neutralgray-700 mb-4">
          ...
          <p className="text-neutralgray-600 mb-4">
            Adopt a cat today and change two lives forever. <br />
            {/**Adopt now button redirects to adopt page */}
            <Link href="/adopt">
              <button className="bg-purple-800 text-white px-6 py-2 rounded-lg hover:bg-purple-600 transition mt-6 cursor-pointer">
                Adopt Now
              </button>
            </Link>
          </p>
