...
export default function AboutPage() {
  return (
    <main className=" bg-[#F6F3FF] px-4 md:px-10 py-16">
      <section className="max-w-5xl mx-auto text-center mb-16">
        <h1 className="text-purple-800 text-5xl font-extrabold mb-4">
          About KatPaw 🐾
        </h1>
      ...
      <section className="text-gray-700 max-w-4xl mx-auto space-y-6 text-lg leading-relaxed mb-20">
        ...
        <p>
          Today, atPaw is powered by passionate volunteers, adopters, and
      ...
      <section className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 mb-20">
        <div className="bg-[#EDE9FE] rounded-xl shadow-md p-6">
          <h2 className="text-2xl text-gray-600 font-semibold mb-3 text-center">
            Our Mission
          </h2>
      ...
      <section className="max-w-4xl mx-auto mb-20">
        ...
        <ol className="list-decimal list-inside space-y-3 text-lg text-darkgray-700 mb-10">
          <li className="flex items-start gap-4">
            <span className="w-8 h-8 flex items-center justify-center rounded-full bg-purple-800 text-white font-bold">
              1
            </span>
            <div>
